    ...
    methods
        ...
        function [ settings ] = settings(obj)
            settings = strcat('runTime = ',num2str(obj.runTime),'; sigma = ',num2str(obj.sigma),...
                ...
                '; timeToDeleteSelf = ', num2str(obj.timeToDeleteSelf),...
                '; timeToDeleteOther = ', num2str(obj.timeToDeleteOther),'; k1 = ',num2str(obj.k1),'; k2 = ',...
                ...
                num2str(obj.firstStepSpeed), '; precision = ', num2str(obj.precision),...
                 '; shape = ',num2str(obj.shape), '; radius = ', num2str(obj.radius));
